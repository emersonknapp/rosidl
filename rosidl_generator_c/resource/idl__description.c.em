...
message_typename = type_description['type_description']['type_name'].replace('/', '__')
...
// Declare and define all typenames, field names, and default values
@[for itype_description in [type_description['type_description']] + type_description['referenced_type_descriptions']]@
...
// Construct all IndividualTypeDescriptions
@[for itype_description in [type_description['type_description']] + type_description['referenced_type_descriptions']]@
@{ td_typename = itype_description['type_name'].replace('/', '__') }@
...
// Construct all interface TypeDescriptions
