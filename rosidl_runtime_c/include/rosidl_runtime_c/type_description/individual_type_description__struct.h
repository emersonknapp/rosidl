...
#define rosidl_runtime_c__type_description__IndividualTypeDescription__TYPE_VERSION_HASH__INIT {1, { \
...
static const rosidl_type_hash_t rosidl_runtime_c__type_description__IndividualTypeDescription__TYPE_VERSION_HASH = rosidl_runtime_c__type_description__IndividualTypeDescription__TYPE_VERSION_HASH__INIT;

/// Type Description for interface, defined in compilation unit
// extern const rosidl_runtime_c__type_description__TypeDescription rosidl_runtime_c__type_description__IndividualTypeDescription__TYPE_DESCRIPTION;
