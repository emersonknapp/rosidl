...
#
# Usage:
# Call this script from any directory, but caller must set the following environment variables or script will fail
...
# comment out type description declaration - these types are normal structs, they will not be self-describing
